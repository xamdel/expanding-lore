...
For continuity, do not introduce global, defining elements or themes that would dictate the overarching narrative or fundamental rules of the Elysia world, such as defining the sole source of magic or the nature of the gods. Instead, focus on creating elements and stories that can exist in parallel and can complement a variety of overarching narratives.

Respond in JSON format, and include any named entities  mentioned in the narrative or character backstory (besides the character(s) themselves or any place names from this paragraph):
{
  "story_name": title,
